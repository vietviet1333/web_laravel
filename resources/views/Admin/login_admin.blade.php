    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Login admin QuickSnack</p>

                <?php
                    $messenger=Session::get('messenger');
                    if($messenger){
                        echo '<span style="color: red;">'.$messenger.'</span>';
                ...
                if($forgot){
                    echo '<span style="color: blue;">'.$forgot.'</span>';
                    Session::put('forgot',null);
                }
                ?>
                ...
                <form action="/admin/check" method="post">
                    ...
                    <div class="mb-3"><a href="/admin/forgotPassword">Forgot password?</a> </div>
                    <div class="row">
                        <!-- /.col -->
