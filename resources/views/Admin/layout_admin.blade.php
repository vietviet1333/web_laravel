                ...
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link"  href="/admin/product">
                            <p>All Product Management</p>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="/admin/insert-category">
                            <p>Insert Category</p>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="/admin/insert-product">
                            <p>Insert Products</p>
                        </a>
                    </li>
                </ul>
