...
<body>
                ...
                <ul class="menu" style="display: flex;list-style: none">
                    ...
                    <li class="down"><i class="fa-solid fa-magnifying-glass"
                        ...
                        <ul class="drop" style="right: 0;border-radius:30px">
                            <li><input type="text" placeholder="Tìm kiếm..." style="border-radius: 15px"
                                    id="search"></li>
                            <li> @csrf
                                <div id="show"></div>
                            </li>
                        ...
                        <ul class="drop" style="right: 0;border-radius:10px">
                            @php
                                if (Session::get('id')) {
                                    ...
                                    echo '<li style="padding:0"><a href="/login" >ĐĂNG NHẬP</a></li>' . '<li style="padding:0"><a href="/register" >ĐĂNG KÝ</a></li>';
                                    echo Session::get('id');
                                }
                            @endphp
                        </ul>
    ...
    <footer>
        ...
        {{-- <div style="display: flex">
            <div class="lofo">
                <div> <img src="{{ asset('picture/NTV JR.png') }}" alt=""></div>
                <div class="right" style="margin: auto">
                    <div style="display:flex;padding:5px 10px"><i class="fa-solid fa-location-dot"
                            style="padding-right: 10px"></i>
                        <h6>300/15 Nguyen Van Linh</h6>
                    </div>
                    <div style="display:flex;padding:5px 10px"><i class="fa-sharp fa-solid fa-phone"
                            style="padding-right: 10px"></i>
                        <h6>0393035090</h6>
                    </div>
                    <div style="display:flex;padding:5px 10px"><i class="fa-solid fa-envelope"
                            style="padding-right: 10px"></i>
                        <h6>vietviet1333@gmail.com</h6>
                    </div>
                </div>
                <div class="con"></div>
                <div class="chi">
                    <h6>Chính Sách</h6>
                    <h6 style="font-size: 0.6rem"><a href="/hdmuahang" style="color: black">Hướng Dẫn Mua Hàng</a>
                    </h6>
                    <h6 style="font-size: 0.6rem"><a href="/csdoitra" style="color: black">Chính Sách Đổi Trả</a>
                    </h6>
                </div>
            </div> --}}
            <div style="color:rgb(0, 0, 0);display:flex;background-color:rgb(255, 255, 255);padding-top:30px">
        <div class="center" style="margin: auto;width: 200px;height:50px"><img src="{{asset('picture/NTV JR.png')}}" alt=""></div>
    <div class="right" style="margin: auto">
<div style="display:flex;padding:10px 10px"><i class="fa-solid fa-location-dot" style="padding-right: 10px"></i><h6 style="font-size: 0.7rem;font-weight:bold">300/15 Nguyen Van Linh</h6></div>
<div style="display:flex;padding:10px 10px"><i class="fa-sharp fa-solid fa-phone" style="padding-right: 10px"></i><h6 style="font-size: 0.7rem;font-weight:bold">0393035090</h6></div>
<div style="display:flex;padding:10px 10px"><i class="fa-solid fa-envelope" style="padding-right: 10px"></i><h6 style="font-size: 0.7rem;font-weight:bold">vietviet1333@gmail.com</h6></div>
</div>
...
<div style="text-align: center;color:rgb(0, 0, 0);background-color:rgb(255, 255, 255);padding-top:30px;padding-bottom:20px">
